...
ActiveRecord::Schema.define(version: 2021_12_18_171751) do
  ...
  create_table "chapters", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    ...
    t.index ["repository_id"], name: "index_chapters_on_repository_id"
  end
  ...
  add_foreign_key "chapters", "repositories"
